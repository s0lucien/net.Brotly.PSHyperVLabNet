...
task winfra.surf_net_up -Description "Configure winfra guest (WinSrv2022)" -depends ensure-imported, ensure-vswitches {
    ...
    PSHyperVLabNet\PSHyperVLabNet\Add-VMNetworkAdapter -VMName "winfra" -SwitchName "BrotlyNet_host"
    PSHyperVLabNet\PSHyperVLabNet\Add-VMNetworkAdapter -VMName "winfra" -SwitchName "BrotlyNet_pf2vm"
    PSHyperVLabNet\Connect-VMNetworkAdapter -VMName "winfra" -SwitchName "BrotlyNet_host"
    PSHyperVLabNet\Connect-VMNetworkAdapter -VMName "winfra" -SwitchName "BrotlyNet_pf2vm"
    PSHyperVLabNet\Set-InternalSwitch_GuestDHCP_IP -VMName "winfra" -SwitchName "BrotlyNet_host" -IPAddress "10.10.80.143"
...
task winfra.surf_net_down -Description "Decomission winfra guest (WinSrv2022)" -depends ensure-imported {
    ...
    PSHyperVLabNet\Disconnect-VMNetworkAdapter -VMName "winfra" -SwitchName "BrotlyNet_host"
    PSHyperVLabNet\Disconnect-VMNetworkAdapter -VMName "winfra" -SwitchName "BrotlyNet_pf2vm"
    PSHyperVLabNet\PSHyperVLabNet\Remove-VMNetworkAdapter -VMName "winfra" -SwitchName "BrotlyNet_host"
    PSHyperVLabNet\PSHyperVLabNet\Remove-VMNetworkAdapter -VMName "winfra" -SwitchName "BrotlyNet_pf2vm"

    PSHyperVLabNet\Unset-InternalSwitch_GuestDHCP_IP -VMName "winfra" -SwitchName "BrotlyNet_host"
...
task winfra.surf_vagrant_up -Description "Create winfra guest (WinSrv2022) from vagrant box" -depends ensure-imported {
    ...
    PSHyperVLabNet\Remove-AllVMNetworkAdapters -VMName "winfra"
}
...
task winfra.surf_up -depends ensure-imported,  winfra.surf_vagrant_up, winfra.surf_net_up{
    PSHyperVLabNet\Start-VM "winfra"
}

task winfra.surf_turnoff -depends ensure-imported {
    PSHyperVLabNet\Stop-VM "winfra"
}
...
task linfra.surf_net_up -Description "Configure linfra guest (Ubuntu22.04)" -depends ensure-imported, ensure-vswitches {
    ...
    PSHyperVLabNet\PSHyperVLabNet\Add-VMNetworkAdapter -VMName "linfra" -SwitchName "BrotlyNet_host"
    PSHyperVLabNet\PSHyperVLabNet\Add-VMNetworkAdapter -VMName "linfra" -SwitchName "BrotlyNet_pf2vm"
    PSHyperVLabNet\Connect-VMNetworkAdapter -VMName "linfra" -SwitchName "BrotlyNet_host"
    PSHyperVLabNet\Connect-VMNetworkAdapter -VMName "linfra" -SwitchName "BrotlyNet_pf2vm"
    PSHyperVLabNet\Set-InternalSwitch_GuestDHCP_IP -VMName "linfra" -SwitchName "BrotlyNet_host" -IPAddress "10.10.80.141"
...
task linfra.surf_net_down -Description "Decomission linfra guest (Ubuntu22.04)" -depends ensure-imported {
    ...
    PSHyperVLabNet\Disconnect-VMNetworkAdapter -VMName "linfra" -SwitchName "BrotlyNet_host"
    PSHyperVLabNet\Disconnect-VMNetworkAdapter -VMName "linfra" -SwitchName "BrotlyNet_pf2vm"
    PSHyperVLabNet\PSHyperVLabNet\Remove-VMNetworkAdapter -VMName "linfra" -SwitchName "BrotlyNet_host"
    PSHyperVLabNet\PSHyperVLabNet\Remove-VMNetworkAdapter -VMName "linfra" -SwitchName "BrotlyNet_pf2vm"

    PSHyperVLabNet\Unset-InternalSwitch_GuestDHCP_IP -VMName "linfra" -SwitchName "BrotlyNet_host"
...
task linfra.surf_vagrant_up -Description "Create linfra guest (Ubuntu22.04) from vagrant box" -depends ensure-imported {
    ...
    PSHyperVLabNet\Remove-AllVMNetworkAdapters -VMName "linfra"
}
...
task linfra.surf_up -depends ensure-imported,  linfra.surf_vagrant_up, linfra.surf_net_up{
    PSHyperVLabNet\Start-VM "linfra"
}

task linfra.surf_turnoff -depends ensure-imported {
    PSHyperVLabNet\Stop-VM "linfra"
}
...
task hv.surf_net_up -Description "Configure hv guest (HyperVSrv2019)" -depends ensure-imported, ensure-vswitches {
    ...
    PSHyperVLabNet\PSHyperVLabNet\Add-VMNetworkAdapter -VMName "hv" -SwitchName "BrotlyNet_host"
    PSHyperVLabNet\PSHyperVLabNet\Add-VMNetworkAdapter -VMName "hv" -SwitchName "BrotlyNet_pf2vm"
    PSHyperVLabNet\Connect-VMNetworkAdapter -VMName "hv" -SwitchName "BrotlyNet_host"
    PSHyperVLabNet\Connect-VMNetworkAdapter -VMName "hv" -SwitchName "BrotlyNet_pf2vm"
    PSHyperVLabNet\Set-InternalSwitch_GuestDHCP_IP -VMName "hv" -SwitchName "BrotlyNet_host" -IPAddress "10.10.80.87"
...
task hv.surf_net_down -Description "Decomission hv guest (HyperVSrv2019)" -depends ensure-imported {
    ...
    PSHyperVLabNet\Disconnect-VMNetworkAdapter -VMName "hv" -SwitchName "BrotlyNet_host"
    PSHyperVLabNet\Disconnect-VMNetworkAdapter -VMName "hv" -SwitchName "BrotlyNet_pf2vm"
    PSHyperVLabNet\PSHyperVLabNet\Remove-VMNetworkAdapter -VMName "hv" -SwitchName "BrotlyNet_host"
    PSHyperVLabNet\PSHyperVLabNet\Remove-VMNetworkAdapter -VMName "hv" -SwitchName "BrotlyNet_pf2vm"

    PSHyperVLabNet\Unset-InternalSwitch_GuestDHCP_IP -VMName "hv" -SwitchName "BrotlyNet_host"
...
task hv.surf_vagrant_up -Description "Create hv guest (HyperVSrv2019) from vagrant box" -depends ensure-imported {
    ...
    PSHyperVLabNet\Remove-AllVMNetworkAdapters -VMName "hv"
}
...
task hv.surf_up -depends ensure-imported,  hv.surf_vagrant_up, hv.surf_net_up{
    PSHyperVLabNet\Start-VM "hv"
}

task hv.surf_turnoff -depends ensure-imported {
    PSHyperVLabNet\Stop-VM "hv"
}
